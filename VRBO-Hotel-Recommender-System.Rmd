...
skipgramfilename = paste0(mydir, "/images/Skip-Gram.JPG")
...
To resolve the [Cold Start problem][Deferred Cold Start Link 2], the contextual information that relates destinations (or search terms) to the listings based on the booking information is leveraged.  Given latitude and longitude of the cold listing (for which we have no data), a beliefis formed about the proportion of demand driven from each of the search terms pertaining to related/nearby destinations.  Then the **destination embedding** from the earlier step is used to find the expected **listing embedding** for the cold listing.


### Stage 2:

```{r getDANimagefile, echo=F,warning=F,message=F}
DANfilename = paste0(mydir, "/images/DeepAverageNetwork.JPG")
...
Retargetfilename = paste0(mydir, "/images/Retargeting.JPG")
...
DPRTfilename = paste0(mydir, "/images/Deep-Personalized-Retargeting-System.JPG")
...
HRNNfilename = paste0(mydir, "/images/HRNN.JPG")
